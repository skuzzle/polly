...
public class UpdateItem implements DownloadCallback {
    ...
    private static Logger logger = Logger.getLogger(UpdateItem.class.getName());
    ...
    public UpdateItem(Properties props, File destination) {
        this.props = props;
    ...
    public String toString() {
        return this.props.getProperty(UpdateManager.UPDATE_URL);
    }
}