...
public class TVNextCommand extends AbstractTvCommand {
    ...
    public TVNextCommand(MyPolly polly, TVProgramProvider tvProvider)
        ...
        this.createSignature("Gibt die nächste Sendung für den angegebenen Channel aus.", 
            new Parameter("Sender", Types.STRING));
        this.createSignature("Gibt die nächste Sendung für alle angegebenen Channel aus.", 
